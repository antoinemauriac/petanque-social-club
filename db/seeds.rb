...
puts "creating Users"
  ...
  user7 = User.create(email: "tyty@gmail.com", username: "Brandao", password: "123123", date_of_birth: Faker::Date.between(from: "1930-01-01", to: "2015-01-01"))
  user8 = User.create(email: "trotro@gmail.com", username: "Lucienne", password: "123123", date_of_birth: Faker::Date.between(from: "1930-01-01", to: "2015-01-01"))
  user9 = User.create(email: "tratra@gmail.com", username: "Léo le minot", password: "123123", date_of_birth: Faker::Date.between(from: "1930-01-01", to: "2015-01-01"))
  user10 = User.create(email: "trytry@gmail.com", username: "Dwight S", password: "123123", date_of_birth: Faker::Date.between(from: "1930-01-01", to: "2015-01-01"))
  user11 = User.create(email: "tretre@gmail.com", username: "Hasnia", password: "123123", date_of_birth: Faker::Date.between(from: "1930-01-01", to: "2015-01-01"))
  user12 = User.create(email: "blabla@gmail.com", username: "Lilalou", password: "123123", date_of_birth: Faker::Date.between(from: "1930-01-01", to: "2015-01-01"))
  user13 = User.create(email: "lyly@gmail.com", username: "Canto", password: "123123", date_of_birth: Faker::Date.between(from: "1930-01-01", to: "2015-01-01"))
  user14 = User.create(email: "lrolro@gmail.com", username: "La Machine", password: "123123", date_of_birth: Faker::Date.between(from: "1930-01-01", to: "2015-01-01"))
  user15= User.create(email: "lralra@gmail.com", username: "Le sécateur", password: "123123", date_of_birth: Faker::Date.between(from: "1930-01-01", to: "2015-01-01"))
  user16 = User.create(email: "lrylry@gmail.com", username: "Beyoncé 💫", password: "123123", date_of_birth: Faker::Date.between(from: "1930-01-01", to: "2015-01-01"))
  user17 = User.create(email: "lrelre@gmail.com", username: "Mamad", password: "123123", date_of_birth: Faker::Date.between(from: "1930-01-01", to: "2015-01-01"))
  user18 = User.create(email: "tlatla@gmail.com", username: "Habibi", password: "123123", date_of_birth: Faker::Date.between(from: "1930-01-01", to: "2015-01-01"))
  user19 = User.create(email: "rere@gmail.com", username: "Habiba", password: "123123", date_of_birth: Faker::Date.between(from: "1930-01-01", to: "2015-01-01"))
  user20 = User.create(email: "lala@gmail.com", username: "Inti la queen", password: "123123", date_of_birth: Faker::Date.between(from: "1930-01-01", to: "2015-01-01"))
